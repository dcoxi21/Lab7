...
/**
 * @author Dan Cox
 * <br>Sets the acceptable standards for user inputs.
 */
public class RPSLSpock {
    ...
    /**
     * @author Dan Cox
     * **Analyzes the input from user, determines the validity of the input, and
     * assigns a value to the variable pick.**
     * @param pick **string input by user**
     * @return pick **assigned value to pick**
     */
    ...
    /**
     * @author Dan Cox
     * Generates random number and assigns each possible integer to a string.**
     * @return **randomly generated string variable.**
     */
    ...
    /**
     * @author Dan Cox
     * **Based from the variables chosen by the user and the program, this method determines when the program's choice wins.**
     * @param c_pick **computer's randomly generated string**
     * @param h_pick **user's input**
     * @return boolean **true false on whether computer won the match or not.**
     */
